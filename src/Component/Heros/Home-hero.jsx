        ...
        <div className="row">
          <div className="col-lg-5 col-md-5">
            <div className="hero-content">
              <h2>Bussiness Training Center and Incubator</h2>
              {/* <p>
                We are a team of passionate entrepreneurs, engineers, designers and researcher who are committed to creating innovative products that can make
             </p> */}
